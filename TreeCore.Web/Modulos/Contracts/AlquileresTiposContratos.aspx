<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlquileresTiposContratos.aspx.cs" Inherits="TreeCore.ModGlobal.AlquileresTiposContratos" %>
                    ...
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField
                                ...
                                Cls="ico-exclamacion-10px-grey"
                                CausesValidation="true"
                                meta:resourceKey="txtTipoContrato">
                                <Listeners>
                                    <Change Fn="anadirClsNoValido" />
                                    <FocusLeave Fn="anadirClsNoValido" />
                                </Listeners>
                            ...
                            <ext:Toolbar
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('AlquileresTiposContratos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar
                                runat="server"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    ...
                                    Width="250"
                                    meta:resourceKey="colTipoContrato" />
                                <ext:Column
