...
function AgregarEditar() {
    ...
    showLoadMask(App.grid, function (load) {
        App.txtAlquilerConcepto.focus(false, 200);
...
function RecargarAreaFuncional() {
    recargarCombos([App.cmbAreaFuncional]);
}

function SeleccionarAreaFuncional() {
    App.cmbAreaFuncional.getTrigger(0).show();
}
