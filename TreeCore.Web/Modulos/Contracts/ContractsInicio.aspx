<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractsInicio.aspx.cs" Inherits="TreeCore.Modulos.Contracts.ContractsInicio" %>
            ...
            <ext:Viewport ID="vwResp"
                ...
                <Items>
                    ...
                    <ext:Container ID="ctMain1"
                        ...
                        <Items>
                            <ext:Panel runat="server" ID="ContractsHeader" Cls="HeaderInicio">
                                <Items>
                                    <ext:Image
                                        runat="server"
                                        Src="../../ima/modulos/modLegalizaciones.svg"
                                        Height="80"
                                        Width="80"
                                        MarginSpec="0 5 0 0"
                                        Cls="image-title"
