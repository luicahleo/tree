...
{
    public partial class AlquileresTiposContratos : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<ContractTypeDTO> listaDatos = null;
                        ...
                        BaseAPIClient<ContractTypeDTO> aPIClient = new BaseAPIClient<ContractTypeDTO>(TOKEN_API);
...

        {
            ...
            try
            {
                if (!agregar)
                {
                    ...
                    oDato.Name = txtTipoContrato.Text;
                ...
                {
                    oDato = new ContractTypeDTO
                    {
                        Name = txtTipoContrato.Text,
                        Code = txtCodigo.Text,
        ...
        public DirectResponse MostrarEditar()
        {
            ...
            try
            {
                ...
                txtTipoContrato.Text = oDato.Value.Name;
        ...
        public DirectResponse AsignarPorDefecto()
        {
            ...
            BaseAPIClient<ContractTypeDTO> ApiClient = new BaseAPIClient<ContractTypeDTO>(TOKEN_API);
            ContractTypeDTO oDato;
            ResultDto<ContractTypeDTO> oResult;
