<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreasFuncionales.aspx.cs" Inherits="TreeCore.ModGlobal.AreasFuncionales" %>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtAreaFuncional" 
                                runat="server" 
                                ...
                                ValidationGroup="FORM"
                                CausesValidation="true" 
                                meta:resourceKey="txtAreaFuncional" />
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('AreasFuncionales', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="Name" 
                                    ...
                                    Width="250"
                                    meta:resourceKey="columnAreaFuncional" 
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
