<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VexCriticidades.aspx.cs" Inherits="TreeCore.ModGlobal.VexCriticidades" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="VexCriticidadID">
                        <Fields>

                            <ext:ModelField Name="VexCriticidadID" Type="Int" />
                            <ext:ModelField Name="VexCriticidad" />
                            <ext:ModelField Name="CodigoCriticidad" />
                ...
                <Sorters>
                    <ext:DataSorter Property="CodigoCriticidad" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtVexCriticidad"
                                meta:resourceKey="txtVexCriticidad" 
                            ...
                            <ext:TextField ID="txtCodigoCriticidad" 
                                meta:resourceKey="txtCodigoCriticidad" 
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('VexCriticidades', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="VexCriticidad" 
                                    ID="colVexCriticidad" runat="server"
                                    Width="150"  
                                    meta:resourceKey="colVexCriticidad" 
                                    Text="<%$ Resources:Comun, strCriticidad %>" />
                                <ext:Column DataIndex="CodigoCriticidad" 
                                    ID="colCodigoCriticidad" runat="server" 
                                    Width="80" 
                                    meta:resourceKey="colCodigoCriticidad" 
