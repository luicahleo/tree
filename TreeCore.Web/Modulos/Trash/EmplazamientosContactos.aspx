<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmplazamientosContactos.aspx.cs" Inherits="TreeCore.ModGlobal.pages.EmplazamientosContactos" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
                    ...
                    <ext:GridPanel
                        ...
                        <DockedItems>
                            ...
                            <ext:Container runat="server" Dock="Top">
                                <Content>
                                    <local:toolbarFiltros ID="toolbarFiltros" runat="server" />
                                </Content>
                            </ext:Container>
                                ...
                                <Model>
                                    <ext:Model runat="server">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="TipoContacto" />
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    meta:resourceKey="colCName"
                                    ID="colCName"
                                    runat="server"
                                    Text="Name"
                                    DataIndex="Nombre" />

                                <ext:Column runat="server" ID="colApellidos" DataIndex="Apellidos" Text="Apellidos"
                                    meta:resourceKey="colApellidos">
                                </ext:Column>

                                <ext:Column
                                    meta:resourceKey="colTelefono"
                                    ID="colTelefono"
                                    runat="server"
                                    Text="Phone"
                                    DataIndex="Telefono" />
                                <ext:Column
                                    meta:resourceKey="colEmail"
                                    ID="colEmail"
                                    runat="server"
                                    Text="Email"
                                    DataIndex="Email" />
                                ...
                                <ext:Column
                                    ...
                                    DataIndex="Pais" />
                                <ext:Column
                                    meta:resourceKey="colTipoContacto"
                                    ID="colTipoContacto"
                                    runat="server"
                                    Text="Type"
