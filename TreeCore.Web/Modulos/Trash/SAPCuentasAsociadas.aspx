<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPCuentasAsociadas.aspx.cs" Inherits="TreeCore.ModGlobal.SAPCuentasAsociadas" %>
        ...
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model
                        runat="server"
                        IDProperty="SAPCuentaAsociadaID">
                        <Fields>
                            <ext:ModelField
                                Name="SAPCuentaAsociadaID"
                                Type="Int" />
                            <ext:ModelField Name="SAPCuentaAsociada" />
            ...
            <ext:Window
                ...
                <Items>
                    <ext:FormPanel
                        ...
                        <Items>
                            <ext:TextField
                                ID="txtSAPCuentaAsociadas"
                                runat="server"
                                WidthSpec="100%"
                                LabelAlign="Top"
                                FieldLabel="Cuenta Asociadas"
                                Text=""
                                MaxLength="6"
                                ...
                                meta:resourceKey="txtSAPCuentaAsociadas" />
                            <ext:TextField
                                ID="txtDescripcion"
                                runat="server"
                                WidthSpec="100%"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('SAPCuentasAsociadas', hdCliID.value, #{grid}, '');" />
                                    <ext:Button
                                        runat="server"
                                        ID="btnActivar"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    DataIndex="SAPCuentaAsociada"
                                    Text="<%$ Resources:Comun, strCuentaAsociada %>"
                                    Width="150"
                                    meta:resourceKey="colSAPCuentaAsociada"
                                    ID="SAPCuentaAsociada"
                                    runat="server" />
                                <ext:Column
