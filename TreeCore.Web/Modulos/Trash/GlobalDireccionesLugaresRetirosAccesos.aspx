<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalDireccionesLugaresRetirosAccesos.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalDireccionesLugaresRetirosAccesos" %>
        ...
        <div>
            ...
            <ext:Store 
                ...
                <Model>
                    <ext:Model 
                        runat="server" 
                        IDProperty="GlobalDireccionLugarRetiroAccesoID">
                        <Fields>
                            <ext:ModelField Name="GlobalDireccionLugarRetiroAccesoID" Type="Int" />
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar
                                ...
                                <Items>
                                    ...
                                    <ext:Button 
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalDireccionesLugaresRetirosAccesos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar 
                                runat="server"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column  
                                    DataIndex="Nombre" 
                                    Header="<%$ Resources:Comun, strNombre %>" 
                                    Width="250"
                                    ID="colNombre"
                                    runat="server"
                                    Flex="1" />
