<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalDireccionesTiposLlavesAccesos.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalDireccionesTiposLlavesAccesos" %>
        ...
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model
                        runat="server"
                        IDProperty="GlobalDireccionTipoLlaveAccesoID">
                        <Fields>
                            <ext:ModelField Name="GlobalDireccionTipoLlaveAccesoID" Type="Int" />
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalDireccionesTiposLlavesAccesos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
