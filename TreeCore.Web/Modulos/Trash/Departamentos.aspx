<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departamentos.aspx.cs" Inherits="TreeCore.ModGlobal.Departamentos" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:ResourceManager runat="server" ID="ResourceManagerTreeCore"
                    ...
                    <ext:FormPanel 
                        ...
                        <Items>
                            <ext:TextField 
                                ...
                                meta:resourceKey="txtDepartamento" />
                        </Items>
                        <Listeners>
                            ...
                            <ext:Toolbar 
                                ...
                                <Items>
                                    ...
                                    <ext:Button
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('Departamentos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar 
                                runat="server"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column 
                                    ...
                                    Width="250" 
                                    meta:resourceKey="columnDepartamento" 
                                    ID="colDepartamento" 
                                    runat="server" 
                                    Flex="1" />
                            </Columns>
