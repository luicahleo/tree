...
function Grid_RowSelect(sender, registro, index) {
    ...
    if (datos != null) {
        ...
        App.ModuloID.setValue(seleccionado.VexProyectoID);
    }

    TreeCore.mostrarDetalle(seleccionado.VexProyectoID);
}
...
function AgregarEditar() {
    VaciarFormulario();
    App.txtVexProyecto.focus(false, 500);
...
function AgregarEditarDetalle() {
    ...
    App.txtVexSeccion.focus(false, 500);
