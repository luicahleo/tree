...
function VaciarFormulario() {
    ...
    App.cmbSociedad.getTrigger(0).hide();
}
...
function AgregarEditar() {
    VaciarFormulario();
    App.txtCentroCoste.focus(false, 200);
...
function ajaxEditar() {
    ...
    if (seleccionado.SociedadID != null) {
        App.cmbSociedad.getTrigger(0).show();
    }
...
function SeleccionarSociedad() {
    App.cmbSociedad.getTrigger(0).show();
}

function RecargarSociedad() {
    recargarCombos([App.cmbSociedad]);
}
