<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPIFRS16TratamientosPrevios.aspx.cs" Inherits="TreeCore.ModGlobal.SAPIFRS16TratamientosPrevios" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="IFRS16TratamientoPrevioID">
                        <Fields>

                            <ext:ModelField Name="IFRS16TratamientoPrevioID" Type="Int" />
                            <ext:ModelField Name="IFRS16TratamientoPrevio" />
                ...
                <Sorters>
                    <ext:DataSorter 
                        Property="IFRS16TratamientoPrevio"
                        Direction="ASC" />
                </Sorters>
            </ext:Store>
            ...
            <ext:Window
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField 
                                ID="txtTratamientosPrevios" 
                                runat="server" 
                                FieldLabel="strTratamientoPrevio" 
                                Text="" 
                                MaxLength="50"
                                ...
                                meta:resourceKey="txtTratamientosPrevios" />
                            <ext:TextArea
                                ID="txtDescripcion" 
                                runat="server" 
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar 
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('SAPIFRS16TratamientosPrevios', hdCliID.value, #{grid}, App.btnActivos.pressed);" />
                                </Items>
                            </ext:Toolbar>
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="IFRS16TratamientoPrevio" 
                                    ID="colTratamientoPrevio" runat="server" 
                                    Header="<%$ Resources:Comun, strTratamientoPrevio %>" 
                                    Width="150" 
                                    meta:resourceKey="colTratamientoPrevio" 
                                    Flex="1" />
