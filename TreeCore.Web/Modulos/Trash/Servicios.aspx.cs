...
{
    public partial class Servicios : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<Data.ToolServicios> listaDatos;
        ...
        private List<Data.ToolServicios> ListaPrincipal(int iStart, int iLimit, string sSort, string sDir, ref int iCount, string sFiltro, long? lClienteID)
        {
            List<Data.ToolServicios> listaDatos;
            ToolServiciosController cToolServicios = new ToolServiciosController();

            try
            {
                if (lClienteID.HasValue)
                {
                    listaDatos = cToolServicios.GetItemsWithExtNetFilterList<Data.ToolServicios>(sFiltro, sSort, sDir, iStart, iLimit, ref iCount, "ClienteID == " + lClienteID);
                }
                else
                {
                    listaDatos = null; 
        ...
        public DirectResponse AgregarEditar(bool bAgregar)
        {
            ...
            ToolServiciosController cServicios = new ToolServiciosController();
            long lCliID = 0;
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    Data.ToolServicios oDato;
                    oDato = cServicios.GetItem(lS);
                    
                    if (oDato.Servicio == txtServicio.Text)
                    {
                        oDato.Servicio = txtServicio.Text;
                    }
                    else
                    {
                        lCliID = long.Parse(hdCliID.Value.ToString());
                        if (cServicios.RegistroDuplicado(txtServicio.Text, lCliID))
                        {
                    ...
                    if (cServicios.UpdateItem(oDato))
                    {
                ...
                else
                {
                    ...
                    {
                        Data.ToolServicios oDato = new Data.ToolServicios
                        {
                        ...
                        if (cServicios.AddItem(oDato) != null)
                        {
        ...
        public DirectResponse MostrarEditar()
        {
            ...
            try
            {
                ...
                Data.ToolServicios oDato;
                oDato = cServicios.GetItem(lS);
                txtServicio.Text = oDato.Servicio;
        ...
        public DirectResponse AsignarPorDefecto()
        {
            ...
            try
            {
                ...
                oDato = cToolServicios.GetDefault(long.Parse(hdCliID.Value.ToString()));
                ...
                if (oDato != null)
                {
                    if (oDato.ClienteID != lID)
                    {
                        if (oDato.Defecto)
                        {
                            ...
                            cToolServicios.UpdateItem(oDato);
                        }

                        oDato = cToolServicios.GetItem(lID);
                        oDato.Defecto = true;
                        oDato.Activo = true;
                        cToolServicios.UpdateItem(oDato);
                    }
        ...
        public DirectResponse Eliminar()
        {
            ...
            try
            {
                if (cToolServicios.RegistroDefecto(lID))
                {
                    direct.Result = GetGlobalResource(Comun.jsPorDefecto);
                    direct.Success = false;
                }
                else if (cToolServicios.DeleteItem(lID))
                {
        ...
        {
            DirectResponse direct = new DirectResponse();
            ToolServiciosController cController = new ToolServiciosController();
