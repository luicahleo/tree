<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProyectosAgrupaciones.aspx.cs" Inherits="TreeCore.ModGlobal.ProyectosAgrupaciones" %>
        ...
        <div>
            ...
            <ext:Store 
                ...
                <Model>
                    <ext:Model 
                        runat="server" 
                        IDProperty="ProyectoAgrupacionID">
                        <Fields>
                    ...
                    <ext:FormPanel 
                        ...
                        <Items>
                            <ext:TextField 
                                ID="txtAgrupacion"
                                runat="server"
                                FieldLabel="<%$ Resources:Comun, strAgrupacion %>"
                                meta:resourceKey="txtAgrupacion" 
                                Text=""
                                MaxLength="100"
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('ProyectosAgrupaciones', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column 
                                    ID="colAgrupacion" 
                                    runat="server" 
                                    DataIndex="ProyectoAgrupacion" 
                                    meta:resourceKey="colAgrupacion"
                                    Hideable="false"
                                    Width="200"
                                    Header="<%$ Resources:Comun, strAgrupacion %>"
                                    Flex="1">
                                </ext:Column> 
                            </Columns>
                        </ColumnModel>
