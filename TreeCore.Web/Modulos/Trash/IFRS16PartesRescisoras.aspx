<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IFRS16PartesRescisoras.aspx.cs" Inherits="TreeCore.ModGlobal.IFRS16PartesRescisoras" %>
        ...
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model
                        runat="server"
                        IDProperty="IFRS16ParteRescisoraID">
                        <Fields>
                            <ext:ModelField Name="IFRS16ParteRescisora" Type="Int" />
                            <ext:ModelField Name="ParteRescisora" />
                ...
                <Sorters>
                    <ext:DataSorter Property="ParteRescisora" Direction="ASC" />
                </Sorters>
            </ext:Store>
            ...
            <ext:Window runat="server"
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField
                                ID="txtParteRescisora"
                                runat="server"
                                FieldLabel="Parte Rescisora"
                                Text=""
                                MaxLength="50"
                                ...
                                meta:resourceKey="txtParteRescisora" />
                            <ext:TextArea
                                ID="txaDescripcion"
                                runat="server"
                                ...
                                ValidationGroup="FORM"
                                CausesValidation="true"
                                meta:resourceKey="txaDescripcion" />
                            <ext:TextField
                                ID="txtCodigo"
                                runat="server"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar
                                ...
                                <Items>
                                    ...
                                    <ext:Button
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('IFRS16PartesRescisoras', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    DataIndex="ParteRescisora"
                                    Header="Parte Rescisora"
                                    Width="150"
                                    meta:resourceKey="colParteRescisora"
                                    ID="colParteRescisora"
                                    runat="server"
                                    Flex="1" />
                                <ext:Column
                                    ID="colDescripcion"
