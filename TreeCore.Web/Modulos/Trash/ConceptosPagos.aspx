<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConceptosPagos.aspx.cs" Inherits="TreeCore.ModGlobal.ConceptosPagos" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="ConceptoPagoID">
                        <Fields>

                            <ext:ModelField Name="ConceptoPagoID" Type="Int" />
                            <ext:ModelField Name="ConceptoPago" />
                            <ext:ModelField Name="ClienteID" Type="Int" />
                ...
                <Sorters>
                    <ext:DataSorter Property="ConceptoPago" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtConceptoPago" runat="server" FieldLabel="Concepto Pago" Text="" MaxLength="150"
                                MaxLengthText="<%$ Resources:Comun, strMaxLengthText %>" AllowBlank="false"
                                ValidationGroup="FORM" CausesValidation="true" meta:resourceKey="txtConceptoPago" />
                        </Items>
                        <Listeners>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('ConceptosPagos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="ConceptoPago"
                                    ID="ConceptoPago" 
                                    runat="server"
                                    Width="250"
                                    meta:resourceKey="colConceptoPago" 
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
