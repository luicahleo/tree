<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalAreasOyM.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalAreasOyM" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Sorters>
                    <ext:DataSorter Property="AreaOYM" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtAreaOYM" runat="server"
                                FieldLabel="<%$ Resources:Comun, strAreaOandM %>"
                                Text=""
                                MaxLength="200"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalAreasOyM', hdCliID.value, #{grid}, App.btnActivos.pressed);" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="GlobalAreaOYMID"
                                    ID="colGlobalAreaOYM" 
                                    runat="server"
                                    Width="150"
                                    Header="GlobalAreaOYM"
                                    meta:resourceKey="colGlobalAreaOYM"
                                    Hidden="true" />
                                <ext:Column DataIndex="AreaOYM"
                                    ID="colAreaOYM" runat="server"
                                    Width="150"
                                    Header="<%$ Resources:Comun, strAreaOandM %>"
                                    meta:resourceKey="colAreaOYM" />
                                <ext:Column DataIndex="Codigo"
                                    ID="colCodigo" runat="server"
                                    Width="150"
                                    Header="<%$ Resources:Comun, strCodigo %>"
                                    meta:resourceKey="colCodigo" Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
