<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPClavesClasificaciones.aspx.cs" Inherits="TreeCore.ModGlobal.SAPClavesClasificaciones" %>
        ...
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model 
                        runat="server" 
                        IDProperty="SAPClaveClasificacionID">
                        <Fields>

                            <ext:ModelField Name="SAPClaveClasificacionID" Type="Int" />
                            <ext:ModelField Name="SAPClaveClasificacion" />
                ...
                <Sorters>
                    <ext:DataSorter Property="SAPClaveClasificacion" Direction="ASC" />
                </Sorters>
            </ext:Store>
            ...
            <ext:Window 
                ...
                <Items>
                    <ext:FormPanel 
                        ...
                        <Items>
                            <ext:TextField
                                ID="txtSAPClaveClasificacion"
                                runat="server"
                                FieldLabel="Clave Clasificación"
                                LabelAlign="Top"
                                WidthSpec="100%"
                                Text=""
                                MaxLength="50"
                                ...
                                meta:resourceKey="txtSAPClaveClasificacion" />
                            <ext:TextField
                                ID="txtDescripcion"
                                runat="server"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar 
                                ...
                                <Items>
                                    ...
                                    <ext:Button 
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('SAPClavesClasificaciones', hdCliID.value, #{grid}, '');" />
                                    <ext:Button
                                        runat="server"
                                        ID="btnActivar"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    ID="SAPClaveClasificacion"
                                    runat="server"
                                    DataIndex="SAPClaveClasificacion"
                                    Text="<%$ Resources:Comun, strClaveClasificacion %>"
                                    Width="150"
                                    meta:resourceKey="colSAPClaveClasificacion" />
                                <ext:Column
                                    ID="Descripcion"
                                    runat="server"
