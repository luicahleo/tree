<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalDireccionesTipos.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalDireccionesTipos" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="GlobalDireccionTipoID">
                        <Fields>
                            <ext:ModelField Name="GlobalDireccionTipoID" Type="Int" />
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalDireccionesTipos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
