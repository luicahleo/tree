<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GruposAutorizaciones.aspx.cs" Inherits="TreeCore.ModGlobal.GruposAutorizaciones" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store 
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="GrupoAutorizacionID">
                        <Fields>
                            <ext:ModelField Name="GrupoAutorizacionID" Type="Int" />
                            <ext:ModelField Name="GrupoAutorizacion" />
                ...
                <Sorters>
                    <ext:DataSorter Property="GrupoAutorizacion" Direction="ASC" />
                </Sorters>
            </ext:Store>
            ...
            <ext:Window 
                ...
                <Items>
                    <ext:FormPanel 
                        ...
                        <Items>
                            <ext:TextField 
                                ID="txtGrupoAutorizacion"
                                runat="server"
                                FieldLabel="Grupo Autorizacion"
                                Text=""
                                MaxLength="150"
                                ...
                                meta:resourceKey="txtGrupoAutorizacion" />
                            <ext:TextArea
                                ID="txtDescripicion"
                                runat="server"
                                Text=""
                                ...
                                ValidationGroup="FORM"
                                CausesValidation="true"
                                meta:resourcekey="txtDescripicion" />
                        </Items>
                        <Listeners>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar 
                                ...
                                <Items>
                                    ...
                                    <ext:Button 
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GruposAutorizaciones', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar
                                runat="server"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="colGrupoAutorizacion" runat="server"
                                    DataIndex="GrupoAutorizacion"
                                    Width="150"
                                    meta:resourceKey="colGrupoAutorizacion" />
                                <ext:Column ID="colDescripcion" runat="server"
