<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalDireccionesTiposCaminos.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalDireccionesTiposCaminos" %>
        ...
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model
                        runat="server"
                        IDProperty="GlobalDireccionTipoCaminoID">
                        <Fields>
                            <ext:ModelField Name="GlobalDireccionTipoCaminoID" Type="Int" />
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalDireccionesTiposCaminos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar
                                runat="server"
