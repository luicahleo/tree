<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalZonas.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalZonas" %>
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="GlobalZonaID">
                        <Fields>
                            ...
                            <ext:ModelField Name="CoordenadasZonas" />
                            <ext:ModelField Name="ClienteID" Type="Int" />
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalZonas', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar
                                runat="server"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    runat="server"
                                    ID="colCoordenadasZonas"
                                    meta:resourceKey="columnCoordenadas"
                                    DataIndex="CoordenadasZonas"
                                    Text="<%$ Resources:Comun, strCoordenadasZonas %>"
                                    Width="850"
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
