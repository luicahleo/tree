<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalMotivosAdendas.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalMotivosAdendas" %>
        ...
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model
                        runat="server"
                        IDProperty="GlobalMotivoAdendaID">
                        <Fields>
                            <ext:ModelField Name="GlobalMotivoAdenda" Type="Int" />
                            <ext:ModelField Name="MotivoAdenda" />
                    ...
                    <ext:FormPanel
                        ...
                        <Items>
                            <ext:TextField
                                ...
                                meta:resourceKey="txtMotivoAdenda" />
                        </Items>
                        <Listeners>
                            ...
                            <ext:Toolbar
                                ...
                                <Items>
                                    ...
                                    <ext:Button
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalMotivosAdendas', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    ID="colMotivoAdenda"
                                    runat="server"
                                    DataIndex="MotivoAdenda"
                                    Header="Motivo Adenda"
                                    Width="150"
                                    meta:resourceKey="colMotivoAdenda"
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
