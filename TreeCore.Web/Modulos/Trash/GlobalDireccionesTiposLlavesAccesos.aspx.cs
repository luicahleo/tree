...
{
    public partial class GlobalDireccionesTiposLlavesAccesos : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<Data.GlobalDireccionesTiposLlavesAccesos> listaDatos;
        ...
        {
            if (listaFuncionalidades.Contains((long)Comun.ModFun.GLO_GlobalDireccionesTiposLlavesAccesos_Lectura))
            {
            ...
            else if (listaFuncionalidades.Contains((long)Comun.ModFun.ACCESO_TOTAL_DIRECCIONES_TIPOS_LLAVES_ACCESOS))
            {
        ...
        private List<Data.GlobalDireccionesTiposLlavesAccesos> ListaPrincipal(int iStart, int iLimit, string sSort, string sDir, ref int iCount, string sFiltro, long? lClienteID)
        {
            List<Data.GlobalDireccionesTiposLlavesAccesos> listaDatos;
            GlobalDireccionesTiposLlavesAccesosController cGlobalDireccionesTiposLlavesAccesos = new GlobalDireccionesTiposLlavesAccesosController();

            try
            {
                if (lClienteID.HasValue)
                {
                    listaDatos = cGlobalDireccionesTiposLlavesAccesos.GetItemsWithExtNetFilterList<Data.GlobalDireccionesTiposLlavesAccesos>(sFiltro, sSort, sDir, iStart, iLimit, ref iCount, "ClienteID == " + lClienteID);
                }
                else
                {
                    listaDatos = null;
        ...
        public DirectResponse AgregarEditar(bool bAgregar)
        {
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    Data.GlobalDireccionesTiposLlavesAccesos oDato;
                    oDato = cGlobalDireccionesTiposLlavesAccesos.GetItem(lS);
                    ...
                    else
                    {
                        ...
                        if (cGlobalDireccionesTiposLlavesAccesos.RegistroDuplicado(txtNombre.Text, lCliID))
                        {
                    ...
                    if (cGlobalDireccionesTiposLlavesAccesos.UpdateItem(oDato))
                    {
                ...
                else
                {
                    ...
                    {
                        Data.GlobalDireccionesTiposLlavesAccesos oDato = new Data.GlobalDireccionesTiposLlavesAccesos();
                        oDato.Nombre = txtNombre.Text;
                        oDato.Activo = true;
                        ...
                        if (cGlobalDireccionesTiposLlavesAccesos.AddItem(oDato) != null)
                        {
        ...
        public DirectResponse MostrarEditar()
        {
            ...
            try
            {
                ...
                Data.GlobalDireccionesTiposLlavesAccesos oDato;
                oDato = cGlobalDireccionesTiposLlavesAccesos.GetItem(lIDSelect);
        ...
        public DirectResponse AsignarPorDefecto()
        {
            ...
            try
            {
                ...
                oDato = cGlobalDireccionesTiposLlavesAccesos.GetDefault(long.Parse(hdCliID.Value.ToString()));
                ...
                if (oDato != null)
                {
                    if (oDato.Defecto)
                    {
                        ...
                        cGlobalDireccionesTiposLlavesAccesos.UpdateItem(oDato);
                    }

                    oDato = cGlobalDireccionesTiposLlavesAccesos.GetItem(lID);
                    oDato.Defecto = true;
                    oDato.Activo = true;
                    cGlobalDireccionesTiposLlavesAccesos.UpdateItem(oDato);
        ...
        public DirectResponse Eliminar()
        {
            ...
            try
            {
                if (cGlobalDireccionesTiposLlavesAccesos.RegistroDefecto(lID))
                {
                    direct.Result = GetGlobalResource(Comun.jsPorDefecto);
                    direct.Success = false;
                }
                else if (cGlobalDireccionesTiposLlavesAccesos.DeleteItem(lID))
                {
