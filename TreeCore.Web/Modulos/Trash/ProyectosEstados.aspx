<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProyectosEstados.aspx.cs" Inherits="TreeCore.ModGlobal.ProyectosEstados" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" 
                ...
                <Sorters>
                    <ext:DataSorter Property="ProyectoEstado" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField
                                runat="server"
                                ID="txtProyectoEstado"
                                meta:resourceKey="txtProyectoEstado"
                                FieldLabel="<%$ Resources:Comun, strProyectoEstado %>"
                                MaxLength="50"
                            ...
                            <ext:TextField
                                meta:resourceKey="txtCodigoProyectoEstado"
                                ID="txtCodigoProyectoEstado"
                                runat="server"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatosSinCliente('ProyectosEstados', #{grid}, '', '', '', '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column runat="server"
                                    ID="colProyectoEstado"
                                    meta:resourceKey="colProyectoEstado" 
                                    DataIndex="ProyectoEstado" 
                                    Text="<%$ Resources:Comun, strProyectoEstado %>"
                                    Width="250" />
                                <ext:Column runat="server"
                                    ID="colCodigo"
