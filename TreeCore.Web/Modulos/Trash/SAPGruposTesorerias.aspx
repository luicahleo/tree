<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPGruposTesorerias.aspx.cs" Inherits="TreeCore.ModGlobal.SAPGruposTesorerias" %>
        ...
        <div>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model
                        runat="server"
                        IDProperty="SAPGrupoTesoreriaID">
                        <Fields>

                            <ext:ModelField Name="SAPGrupoTesoreriaID" Type="Int" />
                            <ext:ModelField Name="SAPGrupoTesoreria" />
                ...
                <Sorters>
                    <ext:DataSorter Property="SAPGrupoTesoreria" Direction="ASC" />
                </Sorters>
            </ext:Store>
            ...
            <ext:Window runat="server"
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField
                                ID="txtSAPGrupoTesoreria"
                                runat="server"
                                FieldLabel="SAPGrupoTesoreria"
                                LabelAlign="Top"
                                WidthSpec="100%"
                                MaxLength="50"
                                ...
                                meta:resourceKey="txtSAPGrupoTesoreria" />
                            <ext:TextField
                                ID="txtDescripcion"
                                runat="server"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('SAPGruposTesorerias', hdCliID.value, #{grid}, '');" />
                                    <ext:Button runat="server"
                                        ID="btnActivar"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column runat="server"
                                    ID="colSAPGrupoTesoreria"
                                    DataIndex="SAPGrupoTesoreria"
                                    meta:resourceKey="colSAPGrupoTesoreria"
                                    Text="<%$ Resources:Comun, strGrupoTesoreria %>"
                                    Width="150" />
                                <ext:Column runat="server"
                                    ID="colDescripcion"
