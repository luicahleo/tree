<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LicenciasTipos.aspx.cs" Inherits="TreeCore.ModGlobal.LicenciasTipos" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server"
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="LicenciaTipoID">
                        <Fields>
                    ...
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField runat="server"
                                ID="txtCodigoLicenciaTipo"
                                meta:resourceKey="txtCodigoLicenciaTipo"
                                FieldLabel="CodigoLicenciaTipo"
                                MaxLength="20"
                            ...
                            <ext:Checkbox runat="server"
                                ID="chkWeb"
                                meta:resourceKey="ckWeb"
                                BoxLabel="Web"
                                ValidationGroup="FORM"
                                CausesValidation="true" />
                            <ext:Checkbox runat="server"
                                ID="chkSoporte"
                                meta:resourceKey="ckSoporte"
                                BoxLabel="Soporte"
                                ValidationGroup="FORM"
                                CausesValidation="true" />
                            <ext:Checkbox runat="server"
                                ID="chkMovil"
                                BoxLabel="<%$ Resources:Comun, strMovil %>"
                                ValidationGroup="FORM"
                                CausesValidation="true" />
                            <ext:Checkbox runat="server"
                                ID="chkActualizaciones"
                                meta:resourceKey="ckWeckActualizaciones"
                                BoxLabel="Actualizaciones"
                                ValidationGroup="FORM"
                                CausesValidation="true" />
                        </Items>
                        <Listeners>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('LicenciasTipos', hdCliID.value, #{grid}, '');" />
                                    <ext:Button runat="server"
                                        ID="btnActivar"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column runat="server"
                                    ID="colCodigoLicenciaTipo"
                                    DataIndex="CodigoLicenciaTipo"
                                    Flex="1"
                                ...
                                <ext:Column runat="server"
                                    ...
                                    meta:resourceKey="columnActualizaciones"
                                ...
                                <ext:Column runat="server"
                                    ID="colSoporte"
                                    meta:resourceKey="columnSoporte"
                                    DataIndex="Soporte"
                                    Text="Soporte"
                                    Width="100"
                                    Align="Center">
