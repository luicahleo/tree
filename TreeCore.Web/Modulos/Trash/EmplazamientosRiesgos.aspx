<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmplazamientosRiesgos.aspx.cs" Inherits="TreeCore.ModGlobal.EmplazamientosRiesgos" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="EmplazamientoRiesgoID">
                        <Fields>

                            <ext:ModelField Name="EmplazamientoRiesgoID" Type="Int" />
                            <ext:ModelField Name="EmplazamientoRiesgo" />
                            <ext:ModelField Name="Criticidad" Type="Int" />
                ...
                <Sorters>
                    <ext:DataSorter Property="EmplazamientoRiesgo" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtRiesgo"
                                runat="server"
                                FieldLabel="<%$ Resources:Comun, strRiesgo %>"
                                Text=""
                                MaxLength="100"
                                ...
                                meta:resourceKey="txtRiesgo" />
                            <ext:NumberField ID="txtCriticidad"
                                runat="server"
                                MaxLength="100"
                                MaxLengthText="<%$ Resources:Comun, strMaxLengthText %>"
                                FieldLabel="<%$ Resources:Comun, strCriticidad %>"
                                Text=""
                                AllowBlank="true"
                                meta:resourceKey="txtCriticidad" />
                        </Items>
                        <Listeners>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('EmplazamientosRiesgos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="EmplazamientoRiesgo"
                                    Width="150"
                                    meta:resourceKey="colEmplazamientoRiesgo"
                                    ID="colEmplazamientoRiesgo"
                                    Header="<%$ Resources:Comun, strRiesgo %>"
                                    runat="server" />
                                <ext:Column DataIndex="Criticidad"
                                    Width="150"
                                    meta:resourceKey="columCriticidad"
                                    Header="<%$ Resources:Comun, strCriticidad %>"
                                    ID="Criticidad"
                                    runat="server"
                                    Flex="1" />
                            </Columns>
