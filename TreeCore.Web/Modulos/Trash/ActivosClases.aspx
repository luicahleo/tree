<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivosClases.aspx.cs" Inherits="TreeCore.ModGlobal.ActivosClases" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" 
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="ActivoClaseID">
                        <Fields>
                            <ext:ModelField Name="ActivoClase" />
                ...
                <Sorters>
                    <ext:DataSorter Property="ActivoClase" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtClase" 
                                runat="server" 
                                FieldLabel="<%$ Resources:Comun, strClase %>"
                                MaxLength="150"
                                MaxLengthText="<%$ Resources:Comun, strMaxLengthText %>"
                                AllowBlank="false"
                                ValidationGroup="FORM" 
                                CausesValidation="true"
                                meta:resourceKey="txtClase" />
                        </Items>
                        <Listeners>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('ActivosClases', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column runat="server"
                                    ID="colActivoClase"
                                    DataIndex="ActivoClase"
                                    Align="Default"
                                    Width="150"
                                    Header="<%$ Resources:Comun, strClase %>"
                                    Text="<%$ Resources:Comun, strClase %>"
                                    meta:resourceKey="colActivoClase" Flex="1">
                                </ext:Column>
