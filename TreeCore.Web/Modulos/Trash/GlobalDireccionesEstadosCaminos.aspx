<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalDireccionesEstadosCaminos.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalDireccionesEstadosCaminos" %>
        ...
        <div>
            ...
            <ext:Store 
                ...
                <Model>
                    <ext:Model 
                        runat="server" 
                        IDProperty="GlobalDireccionEstadoCaminoID">
                        <Fields>
                            <ext:ModelField Name="GlobalDireccionEstadoCaminoID" Type="Int" />
                            ...
                            <ext:Toolbar 
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalDireccionesEstadosCaminos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
