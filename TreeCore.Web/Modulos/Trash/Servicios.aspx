<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Servicios.aspx.cs" Inherits="TreeCore.ModGlobal.Servicios" %>
                            ...
                            <ext:Toolbar
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        ToolTip="<%$ Resources:Comun, btnDefecto.ToolTip %>"
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('Servicios', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar
                                runat="server"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    runat="server"
                                    ID="colServicio"
                                    meta:resourceKey="columServicio"
                                    DataIndex="Servicio"
                                    Text="Servicio"
                                    Width="150"
                                    Flex="1" />
