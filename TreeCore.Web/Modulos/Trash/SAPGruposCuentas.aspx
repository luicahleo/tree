<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPGruposCuentas.aspx.cs" Inherits="TreeCore.ModGlobal.SAPGruposCuentas" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server"
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="SAPGrupoCuentaID">
                        <Fields>
                            ...
                            <ext:ModelField Name="RangoNumero" />
                ...
                <Sorters>
                    <ext:DataSorter Property="SAPGrupoCuenta" Direction="ASC" />
                </Sorters>
            </ext:Store>
                    ...
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField runat="server"
                                ID="txtSAPGrupoCuenta"
                                meta:resourceKey="txtSAPGrupoCuenta"
                                WidthSpec="100%"
                                LabelAlign="Top"
                                FieldLabel="Grupo Cuenta"
                                MaxLength="6"
                            ...
                            <ext:TextField runat="server"
                                ID="txtRangoNumero"
                                meta:resourceKey="txtRangoNumero"
                                WidthSpec="100%"
                                LabelAlign="Top"
                                FieldLabel="Rango Número"
                                MaxLength="4"
                                MaxLengthText="<%$ Resources:Comun, strMaxLengthText %>"
                                AllowBlank="false"
                                ValidationGroup="FORM"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('SAPGruposCuentas', hdCliID.value, #{grid}, '');" />
                                    <ext:Button runat="server"
                                        ID="btnActivar"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column runat="server"
                                    ID="colSAPGrupoCuenta"
                                    meta:resourceKey="colSAPGrupoCuenta"
                                    DataIndex="SAPGrupoCuenta"
                                    Text="Grupo de Cuenta"
                                    Width="150" />
                                <ext:Column runat="server"
                                    ID="colRangoNumero"
                                    meta:resourceKey="colRangoNumero"
                                    DataIndex="RangoNumero"
                                    Text="Rango Número"
                                    Width="150" />
                                <ext:Column runat="server"
                                    ID="colDescripcion"
