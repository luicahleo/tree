...
{
    public partial class GlobalDireccionesTipos : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<Data.GlobalDireccionesTipos> listaDatos;
        ...
        {
            if (listaFuncionalidades.Contains((long)Comun.ModFun.GLO_GlobalDireccionesTipos_Lectura))
            {
            ...
            else if (listaFuncionalidades.Contains((long)Comun.ModFun.ACCESO_TOTAL_DIRECCIONES_TIPOS))
            {
        ...
        private List<Data.GlobalDireccionesTipos> ListaPrincipal(int iStart, int iLimit, string sSort, string sDir, ref int iCount, string sFiltro, long? lClienteID)
        {
            List<Data.GlobalDireccionesTipos> listaDatos;
            GlobalDireccionesTiposController cGlobalDireccionesTipos = new GlobalDireccionesTiposController();

            try
            {
                if (lClienteID.HasValue)
                {
                    listaDatos = cGlobalDireccionesTipos.GetItemsWithExtNetFilterList<Data.GlobalDireccionesTipos>(sFiltro, sSort, sDir, iStart, iLimit, ref iCount, "ClienteID == " + lClienteID);
                }
                else
                {
                    listaDatos = null;
        ...
        public DirectResponse AgregarEditar(bool bAgregar)
        {
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    Data.GlobalDireccionesTipos oDato;
                    oDato = cGlobalDireccionesTipos.GetItem(lIDSeleccionado);
                    ...
                    else
                    {
                        ...
                        if (cGlobalDireccionesTipos.RegistroDuplicado(txtNombre.Text, lCliID))
                        {
                    ...
                    if (cGlobalDireccionesTipos.UpdateItem(oDato))
                    {
                ...
                else
                {
                    ...
                    {
                        Data.GlobalDireccionesTipos oDato = new Data.GlobalDireccionesTipos
                        {
                        ...
                        if (cGlobalDireccionesTipos.AddItem(oDato) != null)
                        {
        ...
        public DirectResponse MostrarEditar()
        {
            ...
            try
            {
                ...
                Data.GlobalDireccionesTipos oDato;
                oDato = cGlobalDireccionesTipos.GetItem(lS);
        ...
        public DirectResponse AsignarPorDefecto()
        {
            ...
            try
            {
                ...
                oDato = cGlobalDireccionesTipos.GetDefault(long.Parse(hdCliID.Value.ToString()));
                ...
                if (oDato != null)
                {
                    if (oDato.Defecto)
                    {
                        ...
                        cGlobalDireccionesTipos.UpdateItem(oDato);
                    }

                    oDato = cGlobalDireccionesTipos.GetItem(lID);
                    oDato.Defecto = true;
                    oDato.Activo = true;
                    cGlobalDireccionesTipos.UpdateItem(oDato);
        ...
        public DirectResponse Eliminar()
        {
            ...
            try
            {
                if (cGlobalDireccionesTipos.RegistroDefecto(lID))
                {
                    direct.Result = GetGlobalResource(Comun.jsPorDefecto);
                    direct.Success = false;
                }
                else if (cGlobalDireccionesTipos.DeleteItem(lID))
                {
