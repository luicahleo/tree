<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalCentrosOperativos.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalCentrosOperativos" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="GlobalCentroOperativoID">
                        <Fields>

                            <ext:ModelField Name="GlobalCentroOperativoID" Type="Int" />
                            <ext:ModelField Name="CentroOperativo" />
                            <ext:ModelField Name="Activo" Type="Boolean" />
                        </Fields>
                    </ext:Model>
                </Model>
                <Sorters>
                    <ext:DataSorter Property="CentroOperativo" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtCentroOperativo" runat="server" FieldLabel="Tipo Estructura" Text="" MaxLength="40"
                                MaxLengthText="Ha superado el máximo número de caracteres" AllowBlank="false"
                                ValidationGroup="FORM" CausesValidation="true" meta:resourceKey="txtCentroOperativo" />
                        </Items>
                        <Listeners>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalCentrosOperativos', hdCliID.value, #{grid}, '');" />
                                    <ext:Button runat="server"
                                        ID="btnActivos"
                                        ToolTip="Activos"
                                        Icon="BulletShape"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="CentroOperativo" Width="150" Header="Centro Operativo" meta:resourceKey="columCentroOperativo" ID="CentroOperativo" runat="server" Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
