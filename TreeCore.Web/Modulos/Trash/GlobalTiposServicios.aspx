<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalTiposServicios.aspx.cs" Inherits="TreeCore.ModGlobal.GlobalTiposServicios" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="GlobalTipoServicioID">
                        <Fields>


                            <ext:ModelField Name="GlobalTipoServicio" />
                ...
                <Sorters>
                    <ext:DataSorter Property="GlobalTipoServicio" Direction="ASC" />
                </Sorters>
            </ext:Store>
            ...
            <ext:Window runat="server"
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        Border="false">
                        <Items>
                            <ext:TextField ID="txtGlobalTipoServicio" runat="server"
                                FieldLabel="Tipos Servicios"
                                Text=""
                                MaxLength="50"
                                ...
                                meta:resourceKey="txtGlobalTipoServicio" />
                        </Items>
                        <Listeners>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('GlobalTiposServicios', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="GlobalTipoServicio"
                                    Text="Tipo Servicio"
                                    Width="150"
                                    meta:resourceKey="colTipoServicio"
                                    ID="GlobalTipoServicio"
                                    runat="server"
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
