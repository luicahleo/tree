<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmplazamientosHistoricos.aspx.cs" Inherits="TreeCore.ModGlobal.pages.EmplazamientosHistoricos" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/EmplazamientosHistoricos.js"></script>
</head>
                                        ...
                                        <Items>
                                            ...
                                            <ext:GridPanel
                                                ...
                                                <Listeners>
                                                    ...
                                                    <RowClick Fn="agregarColumnaDinamicaEmplazamientos"></RowClick>
                                                </Listeners>
                                                ...
                                                <Store>
                                                    <ext:Store ID="storePrincipal" runat="server"
                                                        ...
                                                        listNotPredictive="HistoricoCoreEmplazamientoID,DatosJSON,EmplazamientoID,UsuarioID,FechaModificacion"
                                                        RemoteSort="false"
                                                        RemoteFilter="false">
                                                        <Proxy>
                                                            <ext:PageProxy />
                                                        ...
                                                        <Model>
                                                            <ext:Model runat="server"
                                                                IDProperty="HistoricoCoreEmplazamientoID">
                                                                <Fields>
                                                                    <ext:ModelField Name="HistoricoCoreEmplazamientoID" Type="Int" />
                                                        ...
                                                        <Parameters>
                                                            ...
                                                            <ext:StoreParameter Name="Codigo" Value="HistoricoCoreEmplazamientoID" Mode="Value" Action="read" />
                                            ...
                                            <ext:Panel runat="server"
                                                ...
                                                <Content>
                                                    <ext:GridPanel runat="server"
                                                        ...
                                                        <Listeners>
                                                            <AfterRender Fn="crearColumnaEstadoActualEmplazamientos" />
                                                        </Listeners>
                                                    </ext:GridPanel>
