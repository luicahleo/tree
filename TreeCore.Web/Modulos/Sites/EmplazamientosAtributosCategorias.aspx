<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmplazamientosAtributosCategorias.aspx.cs" Inherits="TreeCore.ModGlobal.EmplazamientosAtributosCategorias" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server"
                ...
                <Model>
                    <ext:Model runat="server"
                        IDProperty="EmplazamientoAtributoCategoriaID">
                        <Fields>
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('EmplazamientosAtributosCategorias', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
