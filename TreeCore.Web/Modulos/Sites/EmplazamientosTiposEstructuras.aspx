<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmplazamientosTiposEstructuras.aspx.cs" Inherits="TreeCore.ModGlobal.EmplazamientosTiposEstructuras" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="EmplazamientoTipoEstructuraID">
                        <Fields>

                            <ext:ModelField Name="EmplazamientoTipoEstructuraID" Type="Int" />
                            <ext:ModelField Name="TipoEstructura" />
                ...
                <Sorters>
                    <ext:DataSorter Property="TipoEstructura" Direction="ASC" />
                </Sorters>
            </ext:Store>
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField ID="txtTipoEstructura" runat="server" 
                                ...
                                meta:resourceKey="txtTipo" />
                            <ext:TextField ID="txtAlias" runat="server" 
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('EmplazamientosTiposEstructuras', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="TipoEstructura"
                                    ID="colTipoEstructura" runat="server"
                                    Width="150" 
                                    Text="<%$ Resources:Comun, strTipoEstructura %>" 
                                    meta:resourceKey="colTipoEstructura" />
                                <ext:Column DataIndex="Alias"
                                    ID="colAlias" runat="server" 
                                    Width="150" 
                                    Text="<%$ Resources:Comun, strAlias %>" 
                                    meta:resourceKey="colAlias" />
