...
{
    public partial class EmplazamientosAtributosCategorias : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<Data.EmplazamientosAtributosCategorias> listaDatos;
        ...
        private List<Data.EmplazamientosAtributosCategorias> ListaPrincipal(int iStart, int iLimit, string sSort, string sDir, ref int iCount, string sFiltro, long? lClienteID)
        {
            List<Data.EmplazamientosAtributosCategorias> listaDatos;
            EmplazamientosAtributosCategoriasController cAtributosCategorias = new EmplazamientosAtributosCategoriasController();

            try
            {
                if (lClienteID != null)
                {
                    listaDatos = cAtributosCategorias.GetItemsWithExtNetFilterList<Data.EmplazamientosAtributosCategorias>(sFiltro, sSort, sDir, iStart, iLimit, ref iCount, "ClienteID == " + lClienteID);
                }
                else
                {
                    listaDatos = null;
...

        {
            ...
            long lCliID = 0;
            EmplazamientosAtributosCategoriasController cCategoria = new EmplazamientosAtributosCategoriasController();
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    else
                    {
                        ...
                        if (cCategoria.RegistroDuplicado(txtNombre.Text, lCliID))
                        {
                ...
                else
                {
                    ...
                    {
                        Data.EmplazamientosAtributosCategorias oDato = new Data.EmplazamientosAtributosCategorias();
                        oDato.Nombre = txtNombre.Text;
                        oDato.Activo = true;
                        ...
                        if (cCategoria.AddItem(oDato) != null)
                        {
        ...
        {
            DirectResponse direct = new DirectResponse();
            EmplazamientosAtributosCategoriasController cController = new EmplazamientosAtributosCategoriasController();
