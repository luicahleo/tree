<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmplazamientosTamanos.aspx.cs" Inherits="TreeCore.ModGlobal.EmplazamientosTamanos" %>
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('EmplazamientosTamanos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="Tamano"
                                    ID="Tamano" runat="server"
                                    Width="250"
                                    Text="<%$ Resources:Comun, strTamano %>"
                                    meta:resourceKey="columTamano" 
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
