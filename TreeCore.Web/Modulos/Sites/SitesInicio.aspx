<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SitesInicio.aspx.cs" Inherits="TreeCore.Modulos.Sites.SitesInicio" %>
            ...
            <ext:Viewport ID="vwResp"
                ...
                <Items>
                    <ext:Container ID="ctMain1"
                        ...
                        Scrollable="Vertical">
                        <Items>
                            <ext:Panel runat="server" ID="SitesHeader" Cls="HeaderInicio">
                                <Items>
                                    <ext:Image
                                        runat="server"
                                        Src="../../ima/modulos/modGIS.svg"
                                        Height="80"
                                        Width="80"
                                        MarginSpec="0 5 0 0"
                                        Cls="image-title"
