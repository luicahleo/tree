<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="InventarioElementoHistoricos.aspx.cs" Inherits="TreeCore.ModGlobal.pages.InventarioElementoHistoricos" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/InventarioElementoHistoricos.js"></script>
</head>
<body class="bodyFMenu">
    <link href="/Modulos/Sites/css/EmplazamientosHistoricos.css" rel="stylesheet" type="text/css" />
    ...
    <form id="form1" runat="server">
        ...
        <ext:Hidden ID="hdEstadoActual" runat="server" />
        <ext:Hidden ID="hdElementoID" runat="server" />
                                        ...
                                        <Items>
                                            ...
                                            <ext:GridPanel
                                                ...
                                                <Listeners>
                                                    ...
                                                    <RowClick Fn="agregarColumnaDinamicaInvElemento"></RowClick>
                                                </Listeners>
                                                ...
                                                <Store>
                                                    <ext:Store ID="storePrincipal"
                                                        runat="server"
                                                        AutoLoad="true"
                                                        OnReadData="storePrincipal_Refresh"
                                                        shearchBox="cmpFiltro_txtSearch"
                                                        listNotPredictive="InventarioElementoHistoricoID,ElementoID,HistoricoAtributosDinamicos,UsuarioID,FechaModificacion"
                                                        RemoteSort="false"
                                                        RemoteFilter="false">
                                                        <Proxy>
                                                            <ext:PageProxy />
                                                        ...
                                                        <Model>
                                                            <ext:Model runat="server"
                                                                IDProperty="InventarioElementoHistoricoID">
                                                                <Fields>
                                                                    <ext:ModelField Name="InventarioElementoHistoricoID" Type="Int" />
                                                                    <ext:ModelField Name="FechaModificacion" Type="Date" />
                                                                    <ext:ModelField Name="HistoricoAtributosDinamicos" Type="String" />
                                                        ...
                                                        <Parameters>
                                                            ...
                                                            <ext:StoreParameter Name="Codigo" Value="InventarioElementoHistoricoID" Mode="Value" Action="read" />
                                                            <ext:StoreParameter Name="Datos" Value="HistoricoAtributosDinamicos" Mode="Value" Action="read" />
                                                        </Parameters>
                                                        <Listeners>
                                            ...
                                            <ext:Panel runat="server"
                                                ...
                                                <Content>
                                                    <ext:GridPanel runat="server"
                                                        ...
                                                        <Listeners>
                                                            <AfterRender Fn="crearColumnaEstadoActualInvElemento" />
                                                        </Listeners>
                                                    </ext:GridPanel>
