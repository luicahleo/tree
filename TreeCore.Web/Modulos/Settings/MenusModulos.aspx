<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenusModulos.aspx.cs" Inherits="TreeCore.ModGlobal.MenusModulos" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" 
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="MenuModuloID">
                        <Fields>

                            <ext:ModelField Name="MenuModuloID" Type="Int" />
                            <ext:ModelField Name="Modulo" />
                            <ext:ModelField Name="RutaModulo" />
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            ...
                            <ext:TextField runat="server"
                                ID="txtRutaModulo"
                                meta:resourceKey="txtRutaModulo"
                                FieldLabel="<%$ Resources:Comun, strRutaModulo %>"
                                MaxLength="200"
                                MaxLengthText="<%$ Resources:Comun, strMaxLengthText %>"
                                AllowBlank="false"
                                ValidationGroup="FORM"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('MenusModulos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                        </DockedItems>
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column runat="server"
                                    ID="colRutaModulo"
                                    meta:resourceKey="colRutaModulo"
                                    DataIndex="RutaModulo"
                                    Width="100"
                                    Text="<%$ Resources:Comun, strRutaModulo %>"
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
                        <SelectionModel>
