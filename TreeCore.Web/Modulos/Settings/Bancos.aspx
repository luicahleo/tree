<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bancos.aspx.cs" Inherits="TreeCore.ModGlobal.Bancos" %>
            ...
            <ext:Window runat="server"
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField
                                meta:resourceKey="txtCodigoBanco"
                                ID="txtCodigoBanco"
                                runat="server"
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('Bancos', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                        </DockedItems>
