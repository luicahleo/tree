<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zonas.aspx.cs" Inherits="TreeCore.ModGlobal.Zonas" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" 
                ...
                <Sorters>
                    <ext:DataSorter Property="Region" Direction="ASC" />
                </Sorters>
            </ext:Store>
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('Zonas', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar runat="server"
                                ID="tlbClientes"
