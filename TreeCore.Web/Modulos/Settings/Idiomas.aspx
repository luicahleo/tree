<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Idiomas.aspx.cs" Inherits="TreeCore.ModGlobal.Idiomas" %>
            ...
            <ext:Store
                ...
                <Model>
                    <ext:Model
                        ...
                        IDProperty="IdiomaID">
                        <Fields>
                            <ext:ModelField Name="IdiomaID" Type="Int" />
                            ...
                            <ext:Toolbar 
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('Idiomas', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                            <ext:Toolbar 
                                runat="server"
