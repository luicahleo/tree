<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GlobalSettingsContenedor.aspx.cs" Inherits="TreeCore.ModGlobal.pages.GlobalSettingsContenedor" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/GlobalSettingsContenedor.js"></script>
</head>
<body>
                                    ...
                                    <ext:Toolbar runat="server"
                                        ...
                                        <Items>
                                            <ext:HyperlinkButton runat="server"
                                                ...
                                                meta:resourceKey="lnkLoginSettings"
                                                Text="Login Settings">
                                                <Listeners>
                                            ...
                                            <ext:HyperlinkButton runat="server"
                                                ID="lnkServicesSettings"
                                                Cls="lnk-navView lnk-noLine"
                                                meta:resourceKey="lnkServicesSettings"
                                        ...
                                        <Items>
                                            <ext:Container ID="hugeCt" runat="server" Layout="FitLayout">
                                                <Loader ID="LoaderMain"
                                                    runat="server"
                                                    Url="../Settings/LoginSettings.aspx"
                                                    Mode="Frame">
                                        ...
                                        <Items>
                                            <ext:Container ID="hugeCt2" runat="server" Layout="FitLayout">
                                                <Loader ID="LoaderMain2"
                                                    runat="server"
                                                    Url="../Settings/ServiceSettings.aspx"
                                                    Mode="Frame">
                                                    <LoadMask ShowMask="true" />
                                                </Loader>
                                            </ext:Container>
                                    ...
                                    <ext:Panel
                                        ...
                                        <DockedItems>
                                            <ext:Toolbar runat="server" ID="MenuNavPnInfo" Cls="noBorder" Padding="0" Dock="Left" Layout="VBoxLayout">
                                                <Items>
                                                    <ext:Button runat="server" Padding="0" Margin="0" ID="btnMoreInfo" Cls="btnInfo-asR btnNoBorder" Handler="displayMenu('pnInfo')"></ext:Button>
                                                </Items>
                                            </ext:Toolbar>
                                        </DockedItems>
                                        <Items>
                                            ...
                                            <ext:Panel
                                                ...
                                                <Items>
                                                    ...
                                                    <ext:Panel
                                                        ...
                                                        <Content>
                                                            <div>
                                                                <table class="tmpCol-table" id="tablaInfo">
                                                                    <tbody id="bodyTablaInfo">
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                        </Content>
