...
{
    public partial class Bancos : TreeCore.Page.BasePageExtNet
    {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        ...
                        try
                        {
                            Comun.ExportacionDesdeListaNombreTask(grid.ColumnModel, listaDatos, Response, "", GetGlobalResource("strBancos").ToString(), _Locale).Wait();
        ...
        public DirectResponse AgregarEditar(bool bAgregar)
        {
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    oDato.Name = txtBanco.Text;
                    oDato.Code = txtCodigoBanco.Text;
        ...
        public DirectResponse MostrarEditar()
        {
            ...
            try
            {
                ...
                txtBanco.Text = oDato.Value.Name;
                txtCodigoBanco.Text = oDato.Value.Code;
