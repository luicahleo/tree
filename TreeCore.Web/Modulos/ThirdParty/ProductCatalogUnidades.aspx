<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductCatalogUnidades.aspx.cs" Inherits="TreeCore.ModGlobal.ProductCatalogUnidades" %>
                                    ...
                                    <ext:Container runat="server" ID="WrapAlturaCabecera" Dock="Top" Layout="VBoxLayout">
                                        ...
                                        <Items>
                                            <ext:Toolbar runat="server" ID="tbTitulo" Dock="Top" Cls="tbGrey tbTitleAlignBot tbNoborder" Hidden="false" Layout="ColumnLayout" Flex="1" MarginSpec="10 0 10 0 ">
                                                <Items>
                                                    <ext:Label runat="server" ID="lbltituloPrincipal" Cls="TituloCabecera" Text="<%$ Resources:Comun, strUnidades %>" Height="25" />
                                                </Items>
                                            </ext:Toolbar>
                                        </Items>
                                    </ext:Container>
                                            ...
                                            <ext:Toolbar
                                                ...
                                                <Items>
                                                    ...
                                                    <ext:Button runat="server"
                                                        ...
                                                        Cls="btnDescargar"
                                                        Handler="ExportarDatos('ProductCatalogUnidades', '', #{grid}, '');" />
                                                    <ext:Button runat="server"
                                                        ID="btnActivar"
