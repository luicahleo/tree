...
{
    public partial class ProductCatalogLifecycleStatus : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<CatalogLifecycleStatusDTO> listaDatos = null;
                        ...
                        try
                        {
                            Comun.ExportacionDesdeListaNombreTask(grid.ColumnModel, listaDatos, Response, "", GetLocalResourceObject("strCatalogLifecycleStatus").ToString(), _Locale).Wait();
        ...
        public DirectResponse AgregarEditar(bool bAgregar)
        {
            ...
            BaseAPIClient<CatalogLifecycleStatusDTO> ApiClient = new BaseAPIClient<CatalogLifecycleStatusDTO>(TOKEN_API);
            CatalogLifecycleStatusDTO oDato;
            ...
            try
            {
                ...
                {
                    oDato = new CatalogLifecycleStatusDTO
                    {
                        Name = txtName.Text,
                        Code = txtCodigo.Text,
        ...
        public DirectResponse AsignarPorDefecto()
        {
            ...
            BaseAPIClient<CatalogLifecycleStatusDTO> ApiClient = new BaseAPIClient<CatalogLifecycleStatusDTO>(TOKEN_API);
            CatalogLifecycleStatusDTO oDato;
            ResultDto<CatalogLifecycleStatusDTO> oResult;
