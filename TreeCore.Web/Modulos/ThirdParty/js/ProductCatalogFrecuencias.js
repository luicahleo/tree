...
function ajaxEditar() {
    VaciarFormulario();
    Agregar = false;
    App.winGestion.setTitle(jsEditar + " " + jsFrecuencia);
...
function AgregarEditar() {
    VaciarFormulario();
    //App.txtSAPTratamiento.focus(false, 200);
    App.winGestion.setTitle(jsAgregar + ' ' + jsFrecuencia);
    Agregar = true;
    App.winGestion.show();
}
