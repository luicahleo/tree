<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThirdInicio.aspx.cs" Inherits="TreeCore.Modulos.ThirdParty.ThirdInicio" %>
            ...
            <ext:Viewport ID="vwResp"
                ...
                <Items>
                    ...
                    <ext:Container ID="ctMain1"
                        ...
                        <Items>
                            <ext:Panel runat="server" ID="ThirdHeader" Cls="HeaderInicio">
                                <Items>
                                    <ext:Image
                                        runat="server"
                                        Src="../../ima/modulos/modThirdparties.svg"
                                        Height="80"
                                        Width="80"
                                        MarginSpec="0 5 0 0"
                                        Cls="image-title"
