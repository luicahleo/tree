...
{
    public partial class CondicionesPagos : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<PaymentTermDTO> listaDatos = null;
                        ...
                        BaseAPIClient<PaymentTermDTO> aPIClient = new BaseAPIClient<PaymentTermDTO>(TOKEN_API);
                        ...
                        try
                        {
                            Comun.ExportacionDesdeListaNombreTask(grid.ColumnModel, listaDatos, Response, "", GetGlobalResource("strCondicionesPagos").ToString(), _Locale).Wait();
        ...
        public DirectResponse AgregarEditar(bool bAgregar)
        {
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    oDato.Name = txtCondicionPago.Text;
                ...
                {
                    oDato = new PaymentTermDTO
                    {
                        Name = txtCondicionPago.Text,
                        Code = txtCodigo.Text,
        ...
        public DirectResponse MostrarEditar()
        {
            ...
            try
            {
                ...
                txtCondicionPago.Text = oDato.Value.Name;
        ...
        public DirectResponse AsignarPorDefecto()
        {
            ...
            BaseAPIClient<PaymentTermDTO> ApiClient = new BaseAPIClient<PaymentTermDTO>(TOKEN_API);
            PaymentTermDTO oDato;
            ResultDto<PaymentTermDTO> oResult;
