...
{
    public partial class TiposContribuyentes : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<TaxpayerTypeDTO> listaDatos = null;
                        ...
                        BaseAPIClient<TaxpayerTypeDTO> aPIClient = new BaseAPIClient<TaxpayerTypeDTO>(TOKEN_API);
                        ...
                        try
                        {
                            Comun.ExportacionDesdeListaNombreTask(grid.ColumnModel, listaDatos, Response, "", GetGlobalResource("strContribuyentes").ToString(), _Locale).Wait();
        ...
        public DirectResponse AgregarEditar(bool bAgregar)
        {
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    oDato.Name = txtTipoContribuyente.Text;
                ...
                {
                    oDato = new TaxpayerTypeDTO
                    {
                        Name = txtTipoContribuyente.Text,
                        Code = txtCodigo.Text,
        ...
        public DirectResponse MostrarEditar()
        {
            ...
            try
            {
                ...
                txtTipoContribuyente.Text = oDato.Value.Name;
        ...
        public DirectResponse AsignarPorDefecto()
        {
            ...
            BaseAPIClient<TaxpayerTypeDTO> ApiClient = new BaseAPIClient<TaxpayerTypeDTO>(TOKEN_API);
            TaxpayerTypeDTO oDato;
            ResultDto<TaxpayerTypeDTO> oResult;
