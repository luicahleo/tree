<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalidadDQCategorias.aspx.cs" Inherits="TreeCore.ModCalidad.CalidadDQCategorias" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server"
                ...
                <Sorters>
                    <ext:DataSorter Property="DQCategoria" Direction="ASC" />
                </Sorters>
            </ext:Store>
                    ...
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField
                                ...
                                meta:resourceKey="txtDQCategoria" />
                        </Items>
                        <Listeners>
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('CalidadDQCategorias', hdCliID.value, #{grid}, App.btnActivo.pressed, '');" />
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column
                                    ...
                                    Header="<%$ Resources:Comun, strCategoria %>"
