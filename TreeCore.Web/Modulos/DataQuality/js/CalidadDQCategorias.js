...
function AgregarEditar() {
    ...
    {
        App.txtDQCategoria.setValue("");
        App.txtDQCategoria.focus(false, 200);
        App.winGestion.setTitle(jsAgregar + ' ' + jsCategoria);
        Agregar = true;
        App.winGestion.show();
        load.hide();
    });
...
function ajaxEditar() {
    VaciarFormulario();
    Agregar = false;
    App.winGestion.setTitle(jsEditar + " " + jsCategoria);
