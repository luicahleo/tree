...
function AgregarEditar() {
    ...
    {
        App.txtDQGrupo.setValue("");
        App.txtDQGrupo.focus(false, 200);
        App.winGestion.setTitle(jsAgregar + ' ' + jsGrupo);
        Agregar = true;
        App.winGestion.show();
        load.hide();
    });
...
function ajaxEditar() {
    VaciarFormulario();
    Agregar = false;
    App.winGestion.setTitle(jsEditar + " " + jsGrupo);
