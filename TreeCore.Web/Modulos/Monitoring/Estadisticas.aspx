<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estadisticas.aspx.cs" Inherits="TreeCore.ModMonitoring.Estadisticas" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server"
                ...
                listNotPredictive="EstadisticaID,ProyectoTipoID,ClienteID,FechaHoraInicio,FechaHoraFin"
                PageSize="20">
                <Proxy>
                    <ext:PageProxy />
                </Proxy>
                <Model>
                    <ext:Model runat="server"
                        IDProperty="EstadisticaID">
                        <Fields>
                            <ext:ModelField Name="EstadisticaID" Type="Int" />
                            <ext:ModelField Name="UsuarioID" Type="Int" />
                            <ext:ModelField Name="Usuario" Type="String" />
                            <ext:ModelField Name="FechaHoraInicio" Type="Date" />
                            <ext:ModelField Name="FechaHoraFin" Type="Date" />
                            <ext:ModelField Name="Pagina" Type="String" />
                            ...
                            <ext:ModelField Name="CodigoAccion" Type="String" />
                            <ext:ModelField Name="AliasProyecto" Type="String" />
                            <ext:ModelField Name="AliasModulo" Type="String" />
                            <ext:ModelField Name="NombreModulo" Type="String" />
                ...
                <Sorters>
                    <ext:DataSorter Property="FechaHoraInicio" Direction="DESC" />
                </Sorters>
            </ext:Store>
                                            ...
                                            <ext:Toolbar runat="server" ID="tlbBase" Dock="Top" Cls="tlbGrid" OverflowHandler="Scroller">
                                                <Items>
                                                    ...
                                                    <ext:Button runat="server"
                                                        ...
                                                        Cls="btnDescargar"
                                                        Handler="ExportarDatos('Estadisticas', hdCliID.value, #{grid}, App.cmpFiltro_cmbFechasRango.value,'',App.cmpFiltro_cmbClientes.value);" />
                                        ...
                                        <ColumnModel runat="server">
                                            <Columns>
                                                <ext:DateColumn
                                                    ...
                                                    MinWidth="120"
                                                    Text="<%$ Resources:Comun, strFechaHoraInicio %>"
                                                    Format="d/m/Y G:i"
                                                    Flex="8"
                                                    ID="FechaHoraInicio"
                                                    runat="server" />
                                                <ext:Column
                                                    DataIndex="AliasProyecto"
                                                    MinWidth="120"
                                                    Flex="8"
                                                    ...
                                                    runat="server" />
                                                <ext:Column
                                                    DataIndex="AliasModulo"
                                                    MinWidth="120"
                                                    Flex="8"
                                                    Text="<%$ Resources:Comun, strPagina %>"
                                                    ID="AliasModulo"
                                                    runat="server">
                                                        <Renderer Fn="asignarTraduccion" />
                                                </ext:Column>
                                                <ext:DateColumn
                                                    DataIndex="FechaHoraFin"
                                                    MinWidth="120"
                                                    Text="<%$ Resources:Comun, strFechaHoraFin %>"
                                                    Format="d/m/Y G:i"
                                                    Flex="8"
                                                    ID="FechaHoraFin"
                                                    runat="server" />
                                                <ext:Column
                                                    ...
                                                    runat="server" />
                                                <ext:Column
                                                    DataIndex="CodigoAccion"
                                                    MinWidth="120"
                                                    Flex="8"
                                                    Text="<%$ Resources:Comun, strCodigoAccion %>"
                                                    ID="CodigoAccion"
                                                    runat="server">
                                                    <Renderer Fn="asignarCodigo" />
                                                </ext:Column>
