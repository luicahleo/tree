<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitoringLogServicio.aspx.cs" Inherits="TreeCore.ModMonitoring.MonitoringLogServicio" %>
                ...
                <Model>
                    <ext:Model runat="server"
                        ...
                        <Fields>
                            ...
                            <ext:ModelField Name="tipoFichero" Type="String" />
                                        ...
                                        <Items>
                                            <ext:Toolbar runat="server" ID="tbTitulo" Dock="Top" Cls="tbGrey tbTitleAlignBot tbNoborder" Hidden="false" Layout="ColumnLayout" Flex="1" >
                                                <Items>
                                                    ...
                                                    <ext:Label runat="server" ID="lbltituloPrincipal" Cls="TituloCabecera" Text="<%$ Resources:Comun, strLogsServicio %>" Height="25" MarginSpec="10 0 10 0" />
                                            ...
                                            <ext:Toolbar runat="server" ID="tlbBase" Dock="Top" Cls="tlbGrid" OverflowHandler="Scroller">
                                                <Items>
                                                    ...
                                                    <ext:Button runat="server"
                                                        ...
                                                        Cls="btnDescargar"
                                                        Handler="ExportarDatosSinCliente('MonitoringLogServicio', #{grid}, App.cmpFiltro_cmbFechasRango.value, '', App.cmpFiltro_cmbClientes.value, hdCarpeta.value);" />
                                                </Items>
                                            </ext:Toolbar>
