...
{
    public partial class Estadisticas : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<Data.Vw_CoreEstadisticas> listaDatos;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            { "Put", new List<ComponentBase> { Button4 }},
        ...
        protected void storePrincipal_Refresh(object sender, Ext.Net.StoreReadDataEventArgs e)
        {
            if (RequestManager.IsAjaxRequest)
            {
                try
                {
                    ...
                    {
                        var lista = ListaPrincipal(e.Start, e.Limit, sSort, sDir, ref iCount, sFiltro, ClienteID);
                        if (lista != null)
                        {
        ...
        private List<Data.Vw_CoreEstadisticas> ListaPrincipal(int iStart, int iLimit, string sSort, string sDir, ref int iCount, string sFiltro, long? lClienteID, string filtroFecha = "")
        {
            List<Data.Vw_CoreEstadisticas> listaDatos;
            EstadisticasController CEstadisticas = new EstadisticasController();
            ...
            try
            {
                ...
                {
                    listaDatos = CEstadisticas.GetItemsWithExtNetFilterList<Data.Vw_CoreEstadisticas>(sFiltro, sSort, sDir, iStart, iLimit, ref iCount, queryFecha);
                }
                else
                {
                    listaDatos = null;
