<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractHistory.aspx.cs" Inherits="TreeCore.ModMonitoring.ContractHistory" %>
                                        ...
                                        <Items>
                                            <ext:Toolbar runat="server" ID="tbTitulo" Dock="Top" Cls="tbGrey tbTitleAlignBot tbNoborder" Hidden="false" Layout="ColumnLayout" Flex="1">
                                                <Items>
                                                    ...
                                                    <ext:Label runat="server" ID="lbltituloPrincipal" Cls="TituloCabecera" Text="<%$ Resources:Comun, strHistorialContrato %>" Height="25" MarginSpec="10 0 10 0" />
                                    ...
                                    <ext:GridPanel
                                        ...
                                        <ColumnModel runat="server">
                                            <Columns>
                                                ...
                                                <ext:WidgetColumn ID="WidgetColumn2" runat="server" Align="Center" Text="More" Hidden="false" MinWidth="90" MaxWidth="90" Filterable="false">
                                                    <Widget>
                                                        <ext:Button runat="server" Width="90" Cls="btnColMore Hidden">
                                                            <Listeners>
                                                            </Listeners>
                                                        </ext:Button>
                                                    </Widget>
                                                </ext:WidgetColumn>
                                                <ext:WidgetColumn ID="WidgetColumn3" runat="server" Align="Center" Text="More" Hidden="false" MinWidth="90" MaxWidth="90" Filterable="false">
                                                    <Widget>
                                                        <ext:Button runat="server" Width="90" Cls="btnColMore Hidden">
                                                            <Listeners>
                                                            </Listeners>
