<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitoringInicio.aspx.cs" Inherits="TreeCore.Modulos.Monitoring.MonitoringInicio" %>
            ...
            <ext:Viewport ID="vwResp"
                ...
                <Items>
                    ...
                    <ext:Container ID="ctMain1"
                        ...
                        <Items>
                            <ext:Panel runat="server" ID="MonitoringHeader" Cls="HeaderInicio">
                                <Items>
                                    <ext:Image
                                        runat="server"
                                        Src="../../ima/modulos/modMonitoring.svg"
                                        Height="80"
                                        Width="80"
                                        MarginSpec="0 5 0 0"
                                        Cls="image-title"
