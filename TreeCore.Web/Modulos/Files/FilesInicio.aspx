<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesInicio.aspx.cs" Inherits="TreeCore.Modulos.Files.FilesInicio" %>
            ...
            <ext:Viewport ID="vwResp"
                ...
                <Items>
                    ...
                    <ext:Container ID="ctMain1"
                        ...
                        <Items>
                            <ext:Panel runat="server" ID="FilesHeader" Cls="HeaderInicio">
                                <Items>
                                    <ext:Image
                                        runat="server"
                                        Src="../../ima/modulos/modDocumental.svg"
                                        Height="80"
                                        Width="80"
                                        MarginSpec="0 5 0 0"
                                        Cls="image-title"
