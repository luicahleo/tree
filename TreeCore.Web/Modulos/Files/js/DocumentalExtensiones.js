...
function AgregarEditar() {
    ...
    {
        App.txtExtension.setValue("");
        App.txtExtension.focus(false, 200);
        App.winGestion.setTitle(jsAgregar + ' ' + jsExtension);
        Agregar = true;
        App.winGestion.show();
        load.hide();
    });
...
function ajaxEditar() {
    VaciarFormulario();
    Agregar = false;
    App.winGestion.setTitle(jsEditar + " " + jsExtension);
