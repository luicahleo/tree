...
{
    public partial class CoreWorkOrdersEstados : TreeCore.Page.BasePageExtNet
    {
        ...
        private void Page_Init(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["opcion"] != null)
            {
                ...
                if (sOpcion == "EXPORTAR")
                {
                    try
                    {
                        List<Data.CoreWorkOrdersEstados> listaDatos;
        ...
        {
            if (listaFuncionalidades.Contains((long)Comun.ModFun.GLO_WorkOrdersEstados_Lectura))
            {
            ...
            else if (listaFuncionalidades.Contains((long)Comun.ModFun.GLO_WorkOrdersEstados_Total))
            {
        ...
        private List<Data.CoreWorkOrdersEstados> ListaPrincipal(int iStart, int iLimit, string sSort, string sDir, ref int iCount, string sFiltro, long? lClienteID)
        {
            List<Data.CoreWorkOrdersEstados> listaDatos;
            ...
            try
            {
                ...
                {
                    listaDatos = cEstados.GetItemsWithExtNetFilterList<Data.CoreWorkOrdersEstados>(sFiltro, sSort, sDir, iStart, iLimit, ref iCount, "ClienteID == " + lClienteID);
                }
                else
                {
                    listaDatos = null;
        ...
        public DirectResponse AgregarEditar(bool bAgregar, string sColor)
        {
            ...
            try
            {
                if (!bAgregar)
                {
                    ...
                    Data.CoreWorkOrdersEstados oDato;
                    ...
                    {
                        //oResponse = cEstados.DiscardChanges();
                        direct.Success = false;
                        direct.Result = GetGlobalResource(oResponse.Description);
                    }
                }
                else
                {
                    ...
                    Data.CoreWorkOrdersEstados oDato = new Data.CoreWorkOrdersEstados();
                    oDato.Nombre = txtNombre.Text;
                    oDato.Codigo = txtCodigo.Text;
                    oDato.Color = sColor;
        ...
        {
            DirectResponse direct = new DirectResponse();
            CoreWorkOrdersEstadosController cCoreWorkOrdersEstados = new CoreWorkOrdersEstadosController();
            ...
            try
            {
                ...
                Data.CoreWorkOrdersEstados oDato;
                oDato = cCoreWorkOrdersEstados.GetItem(lS);

                txtNombre.Text = oDato.Nombre;
                txtCodigo.Text = oDato.Codigo;
                direct.Result = oDato.Color;
                winGestion.Show();
            }
            catch (Exception ex)
            {
        ...
        {
            DirectResponse direct = new DirectResponse();
            CoreWorkOrdersEstadosController cEstado = new CoreWorkOrdersEstadosController();
            InfoResponse oResponse = new InfoResponse();
            ...
            try
            {
                ...
                oDato = cEstado.GetItem(lID);
                oResponse = cEstado.SetDefecto(oDato);
                if (oResponse.Result)
                {
                    oResponse = cEstado.SubmitChanges();
                    if (oResponse.Result)
                    {
                ...
                {
                    //oResponse = cEstado.DiscardChanges();
                    direct.Success = false;
                    direct.Result = GetGlobalResource(oResponse.Description);
                }
            }
        ...
        public DirectResponse Eliminar()
        {
            ...
            try
            {
                var oDato = cEstado.GetItem(lID);
                oResponse = cEstado.Delete(oDato);
                if (oResponse.Result)
                {
                    oResponse = cEstado.SubmitChanges();
                    if (oResponse.Result)
        ...
        {
            DirectResponse direct = new DirectResponse();
            CoreWorkOrdersEstadosController cController = new CoreWorkOrdersEstadosController();
            InfoResponse oResponse = new InfoResponse();
