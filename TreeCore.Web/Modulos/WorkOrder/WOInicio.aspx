<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WOInicio.aspx.cs" Inherits="TreeCore.Modulos.WorkOrder.WOInicio" %>
            ...
            <ext:Viewport ID="vwResp"
                ...
                <Items>
                    <ext:Container ID="ctMain1"
                        ...
                        Scrollable="Vertical">
                        <Items>
                            <ext:Panel runat="server" ID="WOHeader" Cls="HeaderInicio">
                                <Items>
                                    <ext:Image
                                        runat="server"
                                        Src="../../ima/modulos/modWorkOrders.svg"
                                        Height="80"
                                        Width="80"
                                        MarginSpec="0 5 0 0"
                                        Cls="image-title"
