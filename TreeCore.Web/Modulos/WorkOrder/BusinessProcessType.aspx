v<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessProcessType.aspx.cs" Inherits="TreeCore.Modulos.WorkOrder.BusinessProcessType" %>
            ...
            <ext:Window runat="server"
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        <Items>
                            <ext:TextField
                                meta:resourceKey="txtCodigoType"
                                ID="txtCodigoType"
                                runat="server"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('BusinessProcessType', hdCliID.value, #{grid}, '');" />
                                </Items>
                            </ext:Toolbar>
                        </DockedItems>
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column runat="server"
                                    ID="colCodigoBanco"
                                    meta:resourceKey="colCodigoBanco"
                                    DataIndex="Code"
