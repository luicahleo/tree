<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactosTipos.aspx.cs" Inherits="TreeCore.ModGlobal.ContactosTipos" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storePrincipal" RemotePaging="false" AutoLoad="false" OnReadData="storePrincipal_Refresh" RemoteSort="true" PageSize="20">
                ...
                <Model>
                    <ext:Model runat="server" IDProperty="ContactoTipoID">
                        <Fields>
                            <ext:ModelField Name="ContactoTipoID" Type="Int" />
                            <ext:ModelField Name="ContactoTipo" />
                ...
                <Sorters>
                    <ext:DataSorter Property="ContactoTipo" Direction="ASC" />
                </Sorters>
            </ext:Store>
            ...
            <ext:Window runat="server"
                ...
                <Items>
                    <ext:FormPanel runat="server"
                        ...
                        Border="false">
                        <Items>
                            <ext:TextField ID="txtContactoTipo" 
                                runat="server" 
                                WidthSpec="100%"
                                LabelAlign="Top"
                                FieldLabel="<%$ Resources:Comun, strContactoTipo %>"
                                MaxLength="50"
                    ...
                    <ext:GridPanel
                            ...
                            <ext:Toolbar runat="server"
                                ...
                                <Items>
                                    ...
                                    <ext:Button runat="server"
                                        ...
                                        Cls="btnDescargar"
                                        Handler="ExportarDatos('ContactosTipos', hdCliID.value, #{grid}, '');" />
                                    <ext:Button runat="server"
                                        ID="btnActivar"
                        ...
                        <ColumnModel runat="server">
                            <Columns>
                                ...
                                <ext:Column DataIndex="ContactoTipo" 
                                    ID="ContactoTipo" 
                                    runat="server"
                                    Text="<%$ Resources:Comun, strContactoTipo %>"
                                    Width="250"
                                    Flex="1" />
                            </Columns>
                        </ColumnModel>
