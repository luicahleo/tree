<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactInicio.aspx.cs" Inherits="TreeCore.Modulos.Contacts.ContactInicio" %>
            ...
            <ext:Viewport ID="vwResp"
                ...
                <Items>
                    ...
                    <ext:Container ID="ctMain1"
                        ...
                        <Items>
                            <ext:Panel runat="server" ID="Contacts" Cls="HeaderInicio">
                                <Items>
                                    <ext:Image
                                        runat="server"
                                        Src="../../ima/modulos/modSharing.svg"
                                        Height="80"
                                        Width="80"
                                        MarginSpec="0 5 0 0"
                                        Cls="image-title"
