...
{
    public class CoreInventarioElementosAtributosController : GeneralBaseController<CoreInventarioElementosAtributos, TreeCoreContext>
    {
        public CoreInventarioElementosAtributosController()
            : base()
        { }

        public CoreInventarioElementosAtributos GetAtributo(long Elemento, long lAtributoID)
        {
            // Local variable
            CoreInventarioElementosAtributos oDato;
            try
            {
                oDato = (from c in Context.CoreInventarioElementosAtributos where c.InventarioElementoID == Elemento && c.CoreAtributoConfiguracionID == lAtributoID select c).FirstOrDefault();
            }
            catch (Exception ex)
            {
        ...
        public List<CoreInventarioElementosAtributos> GetElementosAtributosByElementoID(long lElementoID)
        {
            List<CoreInventarioElementosAtributos> lista = new List<CoreInventarioElementosAtributos>();
            try
            {
                lista = (from c in Context.CoreInventarioElementosAtributos where c.InventarioElementoID == lElementoID select c).ToList();
            }
            catch (Exception ex)
            {
                log.Error(ex.Message);
        ...
        public InventarioElementosAtributosJson SaveUpdateAtributo(out string descError,
            long lCatID,
            ...
            JsonObject listaObj = null)
        {
            ...
            InventarioElementosAtributosJson oDato = null;
                ...
                else
                {
                    ...
                    switch (oAtributoConf.TiposDatos.Codigo)
                    {
                        case Comun.TIPODATO_CODIGO_TEXTO:
                            ...
                            {
                                oDato = new InventarioElementosAtributosJson
                                {
