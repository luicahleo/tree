...
{
    public class CoreAtributosConfiguracionesController : GeneralBaseController<CoreAtributosConfiguraciones, TreeCoreContext>, IGestionBasica<CoreAtributosConfiguraciones>
    {
        public CoreAtributosConfiguracionesController()
            : base()
        { }

        public InfoResponse Add(CoreAtributosConfiguraciones oAtributo)
        {
            InfoResponse oResponse;

            try
            {
                if (RegistroDuplicado(oAtributo))
                {
        ...
        public InfoResponse Update(CoreAtributosConfiguraciones oAtributo)
        {
            InfoResponse oResponse;
        ...
        public InfoResponse Delete(CoreAtributosConfiguraciones oAtributo)
        {
            InfoResponse oResponse;
        ...
        public bool RegistroDuplicado(CoreAtributosConfiguraciones oAtributo)
        {
            bool isExiste = false;
            List<CoreAtributosConfiguraciones> datos;

            datos = (from c in Context.CoreAtributosConfiguraciones where (c.Nombre == oAtributo.Nombre && c.CoreAtributoConfiguracionID == oAtributo.CoreAtributoConfiguracionID) select c).ToList<CoreAtributosConfiguraciones>();
        ...
        public CoreAtributosConfiguraciones getAtributoByID (long lID)
        {
            CoreAtributosConfiguraciones oDato = null;

            try
            {
                oDato = (from c in Context.CoreAtributosConfiguraciones where c.CoreAtributoConfiguracionID == lID select c).First();
            }
            catch (Exception ex)
            {
                log.Error(ex.Message);
        ...
        public bool NombreAtributoDuplicado (string sNombreAtributo, string sNombreServicio)
        {
            Vw_CoreProductCatalogServiciosAtributosConfiguraciones oServ = new Vw_CoreProductCatalogServiciosAtributosConfiguraciones();
            bool bExiste = false;

            try
            {
                 oServ = (from c in Context.Vw_CoreProductCatalogServiciosAtributosConfiguraciones
                          where c.NombreAtributoConfiguracion == sNombreAtributo 
                          && c.NombreProductCatalogServicio == sNombreServicio select c).First();
