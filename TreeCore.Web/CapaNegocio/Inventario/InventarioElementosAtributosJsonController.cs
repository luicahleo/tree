...
namespace CapaNegocio
{
    ...
    public class InventarioElementosAtributosJsonController
    {
        ...
        public List<InventarioElementosAtributosJson> Deserializacion(string datos)
        {
            List<InventarioElementosAtributosJson> listaAtributos;
            try
            {
                if (datos.StartsWith("["))
                {
                    listaAtributos = JsonConvert.DeserializeObject<List<InventarioElementosAtributosJson>>(datos);
                }
                else
                {
                    if (datos != "{}")
                    ...
                    {
                        listaAtributos = new List<InventarioElementosAtributosJson>();
                    }
                }
            }
            catch (Exception ex)
        ...
        public string Serializacion(List<InventarioElementosAtributosJson> listaDatos)
        {
            string oDato;
            try
            {
    ...
    public class InventarioElementosAtributosJsonComparer : IEqualityComparer<InventarioElementosAtributosJson>
    {
        // Products are equal if their names and product numbers are equal.
        public bool Equals(InventarioElementosAtributosJson x, InventarioElementosAtributosJson y)
        {
        ...
        public int GetHashCode(InventarioElementosAtributosJson product)
        {
...
namespace TreeCore.Data
{
    ...
    public class InventarioElementosAtributosJson
    {
