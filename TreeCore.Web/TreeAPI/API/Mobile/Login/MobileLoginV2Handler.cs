...
namespace TreeAPI.API.Mobile.Login
{
    ...
    public class MobileLoginV2Handler
    {
        ...
        public string Process(System.Web.SessionState.HttpSessionState Session, CryptoHandler cryptoHandler, LoginRequestSOAP req)
        {
            ...
            try
            {
                        ...
                        if (methodInfo != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (result != null)
                                {
                                    ...
                                    {
                                        us = cController.ModificarMAC(us.UsuarioID, req.UserMAC);
                                    }
                ...
                {
                    us = cController.UsuariosLoginAPIV2(req.UserLogin, req.Password, req.UserMAC);
                }
