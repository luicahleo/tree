...
namespace CapaNegocio
{
    public class DocumentosCargasController : GeneralBaseController<DocumentosCargas, TreeCoreContext>
    {
        ...
        public List<DocumentosCargas> GetAllDocumentosNOProcesadosNuevo()
        {
            ...
            try
            {
                lista = (from c in Context.DocumentosCargas where !c.Procesado && c.Activo && (c.DocumentoCargaPlantillaID != 41)
                         && (c.DocumentoCargaPlantillaID != 40) && (c.DocumentoCargaPlantillaID != 39 && (c.DocumentoCargaPlantillaID != 17))
                         orderby c.DocumentoCargaID ascending select c).ToList();
        ...
        public List<Vw_DocumentosCargas> GetAllDocumentosNOProcesadosVwNuevo()
        {
            List<Vw_DocumentosCargas> lista;
