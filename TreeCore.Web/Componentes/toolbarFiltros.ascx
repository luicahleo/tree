<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="toolbarFiltros.ascx.cs" Inherits="TreeCore.Componentes.toolbarFiltros" %>
...
<ext:Toolbar runat="server"
    ...
    <Items>
        ...
        <ext:Container runat="server"
            ...
            Cls="wrapBotonesYcmbFiltros FloatR"
            Hidden="false"
            Height="35"
            Layout="HBoxLayout">
            <Items>
