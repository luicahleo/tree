...
{
    public partial class Grid3Cols : BaseUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.gridcol2row1.Store.Primary.DataSource = this.DataSamplegrid;
            this.gridcol2row2.Store.Primary.DataSource = this.DataSamplegrid;
            this.gridcol3row1.Store.Primary.DataSource = this.DataSamplegrid;
            this.gridcol3row2.Store.Primary.DataSource = this.DataSamplegrid;
