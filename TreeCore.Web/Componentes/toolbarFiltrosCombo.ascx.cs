...
namespace TreeCore.Componentes
{
    ...
    public partial class toolbarFiltrosCombo : System.Web.UI.UserControl
    {
        ...
        public long ClienteID
        {
            get
            {
                if (cmbClientes.SelectedItem.Value == null || cmbClientes.SelectedItem.Value == "")
                {
                    ...
                    {
                        cmbClientes.SelectedItem.Value = (string)hdClienteID.Value;
                    }

                    return long.Parse(cmbClientes.Value.ToString());
            ...
            set { this.cmbClientes.Value = value; }
        }
