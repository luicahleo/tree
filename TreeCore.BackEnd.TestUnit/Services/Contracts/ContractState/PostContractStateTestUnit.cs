...
{
    [TestClass]
    public class PostContractStateTestUnit
    {
        //public Mock<GetDependencies<ContractStateDTO, ContractStateEntity>> _dependencies;
        //public Mock<IGetContractStateDependencies> _getDependencies;
        //public Mock<IPutContractStateDependencies> _putDependencies;
        //public PostContractType Subject;
        //public readonly ContractTypeDTO contractTypeDTO;

        //public PostContractStateTestUnit()
        //{
