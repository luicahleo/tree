...
{
    public class PostContractLineEntidad : PutObjectService<ContractLineEntidadDTO, ContractLineEntidadEntity, ContractLineEntidadDTOMapper>
    {
        ...
        public PostContractLineEntidad(PutDependencies<ContractLineEntidadEntity> postDependency, GetDependencies<ContractLineEntidadDTO, ContractLineEntidadEntity> getDependency,
        ...
        IHttpContextAccessor httpcontextAccessor) : base(httpcontextAccessor, postDependency, new ContractLineEntidadValidation())
        {
        ...
        private bool controlRepetido(List<ContractLineEntidadDTO> lista, ContractLineEntidadDTO elemento)
        {
            ...
            int suma = (int)System.Math.Round(lista.Sum(x => x.Percent), System.MidpointRounding.AwayFromZero);
            if (cont > 1 )
            {
                return true;
            }
