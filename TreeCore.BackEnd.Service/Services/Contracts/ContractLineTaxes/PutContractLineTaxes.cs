...
{
    public class PutContractLineTaxes : PutObjectService<ContractLineTaxesDTO, ContractLineTaxesEntity, ContractLineTaxesDTOMapper>
    {
        ...
        public PutContractLineTaxes(PutDependencies<ContractLineTaxesEntity> putDependency, GetDependencies<ContractLineTaxesDTO, ContractLineTaxesEntity> getDependency,
            ...
            IHttpContextAccessor httpcontextAccessor) : base(httpcontextAccessor, putDependency, new ContractLineTaxesValidation())
        {
        ...
        public override async Task<Result<ContractLineTaxesEntity>> ValidateEntity(ContractLineTaxesDTO ocontractlinetaxesDTO, int client, string email, string code = "")
        {
            ...
            ContractLineEntity contractline = await _getDependencyContractLine.GetItemByCode(ocontractlinetaxesDTO.TaxCode, client);
        ...
        public async Task<Result<List<ContractLineTaxesEntity>>> ValidateEntity(List<ContractLineTaxesDTO> listcontractlinetaxesDTO, int client, string code = "")
        {
            ...
            foreach (ContractLineTaxesDTO elemento in listcontractlinetaxesDTO)
            {
                ...
                if (tax != null )
                {
                    listcontractLineTaxesEntity.Add(new ContractLineTaxesEntity(null, null, tax, tax.Valor));
                }
