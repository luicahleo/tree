...
namespace TreeCore
{
    public static class DirectoryMapping
    {
        ...
        public static void setRuta(IConfiguration configuration) {
            _rootDirectory = configuration["PathRoot:SharedValue"];
            _rootTempDirectory = $"{configuration["PathRoot:SharedValue"]}/_temp/";
        ...
        {
            string dir = Path.Combine(_rootDirectory, "Logs");
